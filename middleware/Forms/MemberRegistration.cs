...
namespace BiometricGymSystem.Forms
{
    public partial class MemberRegistration : Form
    {
        ...
        private List<dynamic> _branches;
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Member Registration - Staff Desktop";
        ...
        private async void LoadBranches()
        {
            try
            {
                ...
                _branches = JsonConvert.DeserializeObject<List<dynamic>>(response);
                
                foreach (var branch in _branches)
                {
                    cmbBranch.Items.Add($"{branch.name} (ID: {branch.id})");
                }
